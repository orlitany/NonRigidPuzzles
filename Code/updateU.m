function [u_hat,B] = updateU(C,A,rho,parts_areas,model,corr_functions,main_params,algo_params)
...
%     minimize ( sum( norms( CA - model.eigen_functions'*(aggregate_mat*diag(u))*F ,2,1)  ) + 0.5*algo_params.lambda_s_model*u'*regularizaion_mat*u )
